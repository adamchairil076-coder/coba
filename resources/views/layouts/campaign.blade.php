...
<body>
   ...
   <div class="donation-details-area ptb-100" style="padding-top: 100px;">
      <div class="container">
         ...
         <a href="{{ route('index') }}#donasi" class="back-btn">
         ...
         <div class="row">
               ...
               <div class="details-item">
                  <div class="details-img">
                     ...
                     <div class="d-flex justify-content-between w-full pb-3">
                        <div>
                           <p style="margin: -10px 0 0 0; font-size: 24px;color: #ff6015; font-weight: bold;">
                              Rp {{ number_format($raised, 0, '.',',') }}
                           </p>
                           <p>
                              Terkumpul dari <b>Rp {{ number_format($goals, 0, '.',',') }}</b>
                           </p>
                        </div>
            ...
            <div class="col-lg-5">
               <div class="details-payment p-4 mt-3" style="background-color: #f3f3f3; border-radius: 10px;">
                  <form action="{{ route('donation.store', $id) }}" method="POST">
                     ...
                     <div class="form-group mt-2">
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <input required type="text" class="form-control" name="name" value="{{ auth()->check() ? auth()->user()->name : '' }}">
                           </div>
                     ...
                     <div class="form-group mt-2">
                        ...
                        <textarea required name="address" cols="30" rows="4" class="form-control"></textarea>
                     </div>
               ...
               <div class="mt-5">
                  <h4>Donatur <span class="sub-span">{{ $donations->count() }}</span></h4>
      ...
      <div class="container">
         <div class="copyright-area">
            <p>
               ...
               <a href="{{ route('index') }}">Pesantren dan Rumah Yatim Ruhama</a>
            </p>
         </div>
      </div>
   </footer>
